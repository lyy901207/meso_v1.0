...
#veh_gen_distri="normal-in-whole-generation-period"
# set the sigma of distribution of vehicle generation time stamps
mu_veh_time_gen_preset=900# mean value of normal distribution of vehicle generation time stamps
...
scenario_test_list_multi_OD_para=[4,5]#1,2,3,
...
# start the scenario test due to the parameters in the list
scenario_count=0
for item_para_combination in scenario_test_list_para_combinations:
    # assign the parameters for test    
    ...
    scenario_count+=1
    print "this is scenario ",scenario_count," test of total ", len(scenario_test_list_para_combinations)," scenarios"
    print "it has following parameter-values:"
    print item_para_combination
    ...
    if scenario_count>=14:
        ...
        dic_vehicles,dic_gen_time_vehids,vehicle_id=vehicle_Gen(OD_matrices, veh_gen_distri,vehicle_id,dic_graph_low,median_value_time,dic_nodes,dic_vehicles,dic_gen_time_vehids,mu_veh_time_gen,sigma_veh_time_gen)
